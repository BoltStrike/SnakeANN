#Code written with reference to the blog of the AI learner
...
def display_snake(snake_position, display):
	...
	for position in snake_position:
		pygame.draw.rect(display, purple, pygame.Rect(position[0],position[1],10,10))
	pygame.draw.rect(display, green, pygame.Rect(snake_position[0][0],snake_position[0][1],10,10))
